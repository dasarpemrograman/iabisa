...
// GridMenu removed: slider-based grid settings have been eliminated to prevent resizing
// The grid settings UI (columns/rows sliders and menu) was removed intentionally.
...
export const Area = memo(
  forwardRef(
    (
      ...
      // Avoid SSR/CSR hydration mismatch: only attach dnd-kit listeners/attributes
      // (via `dragHandle`) after the component has mounted on the client.
      // This prevents attributes that differ between server and client from causing
      // hydration warnings (e.g. aria-describedby generated by dnd-kit).
